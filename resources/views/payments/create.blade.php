    ...
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <h2 class="font-semibold text-xl text-gray-800 leading-tight">
                Buat Pembayaran - {{ $order->kode_pemesanan }}
            </h2>
        ...
        <div class="max-w-6xl mx-auto sm:px-6 lg:px-8">
            ...
            <form method="POST" action="{{ route('payments.store', $order) }}" enctype="multipart/form-data">
                ...
                <div class="bg-white p-6 rounded shadow mb-4">
                    <h3 class="font-semibold mb-3">Input Terjual & Sisa</h3>
                                    ...
                                    <tr class="border-b">
                                        ...
                                        <td class="py-2">
                                            ...
                                            <input type="number" min="0" max="{{ $it->qty }}"
                                                   ...
                                                   value="{{ old("items.$i.qty_terjual", 0) }}">
                                        </td>
                                        ...
                                        <td class="py-2">
                                            <input type="number" min="0" max="{{ $it->qty }}"
                                                   ...
                                                   class="border rounded p-2 w-28"
                                                   value="{{ old("items.$i.qty_sisa", $it->qty) }}">
                                        </td>
                                    </tr>
                                @endforeach
                            </tbody>
                ...
                <div class="bg-white p-6 rounded shadow mb-4">
                    ...
                    <div class="mt-4">
                        <label class="block text-sm font-medium mb-1">Bukti Transfer (jika transfer)</label>
